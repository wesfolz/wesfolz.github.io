...
const rows = [
  {
    ...
    text: (
      <SectionText>
        I created an adaptive css gradient background that rescales and
        repositions itself depending on the width of the browser window.
      </SectionText>
    ),
  ...
  },
  {
    ...
    text: (
      <SectionText>
        I added a new interactive team info section with custom transition
        animations.
      </SectionText>
    ),
    title: 'Team Section'
  },
  {
    ...
    text: (
      <SectionText>
        I added and updated the content for the blog section and many of the
        case studies.
      </SectionText>
    ),
    title: 'New Content'
  ...
  return (
    ...
    >
      ...
      <SectionText>
        ...
        &nbsp;is a small digital agency that designs and builds websites and
        mobile apps. Recently they redesigned their website and I was hired to
        implement the new design changes. I added new features, new content, new
        styling and even fixed a few bugs.
      </SectionText>
