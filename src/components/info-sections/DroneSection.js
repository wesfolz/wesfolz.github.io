  ...
  const appRows = [
    {
      ...
      text: (
        <SectionText>
          I used the DroneKit Python API to send commands from the Raspberry Pi
          to the flight controller over USB. I wrote a Flask web server to
          stream video from the Raspberry Pi camera and to accept websocket
          commands from a client application.
        </SectionText>
      ),
      title: "The Backend",
    },
    {
      ...
      text: (
        <SectionText>
          I built an Android app that connected to the Raspberry Pi web server
          to control the drone and view the video stream coming from the
          Raspberry Pi camera.
        </SectionText>
      ),
      title: "The Frontend",
