  ...
  const rows = [
    {
      ...
      text: (
        <SectionText>
          ...
          model of that object. Our app provided a user interface for creating
          new models, capturing images and opening models. To do the conversions
          from images to three dimensional models, we used a number of
          algorithms from the OpenCV library and developed our own custom image
    ...
    },
    {
      ...
      text: (
        <SectionText>
          For my senior capstone project, I worked on an interdisciplinary team
          of engineers to build a system capable of scanning surface terrain and
          outputting three dimensional representations of the terrain. Our
          system integrated LiDAR, IMU and GPS devices. I wrote the algorithms
          for converting an uncorrected three dimensional point cloud to a
          surface mesh.
        </SectionText>
      ),
    ...
    },
    {
      ...
      text: (
        <SectionText>
          Working on a team of four, I helped build, wire and program an
          infrared sensing robot using a PIC24F microcontroller. The robot could
    ...
    },
    {
      ...
      text: (
        <SectionText>
          ...
          encrypt/decrypt and transmit MPEG video data. After optimizing the
          power consumption of our system we found that it was capable of
          encrypting 1080p video at 30fps in real time using a 128-bit AES
          coprocessor operating at 72MHz.
        </SectionText>
      ),
    ...
    },
    {
      ...
      text: (
        <SectionText>
          For my computer architecture class, I worked with a partner to design
          a pipeline processor with forwarding and hazard detection that could
          run MIPS assembly instructions. We mapped the processor onto an FPGA
          board and used it to run our sum of absolute difference algorithm that
          we wrote in assembly.
        </SectionText>
      ),
  ...
  return (
    ...
    >
      ...
      <SectionText>
        ...
        and received both my Bachelor of Science and Master of Science degrees.
        While there I was involved in many different projects and was a teaching
        assistant during the last year of my Master’s degree.
      </SectionText>
