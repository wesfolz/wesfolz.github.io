  ...
  const rows = [
    {
      ...
      text: (
        <SectionText>
          ...
          the UIs for plotting data, building queries and searching for
          telemetry. I improved performance of telemetry database queries by a
          factor of 10.
        </SectionText>
      ),
    ...
    },
    {
      ...
      text: (
        <SectionText>
          ...
          the Orion Multi-Purpose Crew Vehicle and Launch Abort System. I
          designed and implemented innovative UIs for new testing applications.
          I developed an application to power and retrieve data from different
          flight computers for post-landing data analysis.
        </SectionText>
      ),
    ...
    },
    {
      ...
      text: (
        <SectionText>
          ...
          with other teams. I also managed our Jira dashboard and participated
          in software peer reviews.
        </SectionText>
      ),
      title: "Scrum Master",
    },
  ...
  return (
    ...
    >
      ...
      <SectionText>
        ...
        I have been a software engineer for&nbsp;
        <InlineButton color={Colors.lockheed}>
          <a href="https://www.lockheedmartin.com/en-us/capabilities/space.html">
            Lockheed Martin Space Systems
          </a>
        </InlineButton>
        from 2016 - 2019. In my time there, I worked on two different teams,
        doing both embedded programming and full stack web development.
      </SectionText>
