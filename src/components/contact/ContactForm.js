  ...
  return (
    <FormContainer show={show}>
      ...
      {success || error ? null : (
        <div>
          <FormInput
            invalid={fromNameInvalid}
            type='text'
            placeholder='Name'
            value={fromName}
            onChange={(e) => {
              setFromNameInvalid(!e.target.value);
              setFromName(e.target.value);
            }}
          />
          <FormInput
            invalid={fromEmailInvalid}
            type='email'
            placeholder='Email'
            value={fromEmail}
            onChange={(e) => {
              setFromEmailInvalid(!e.target.value.match(EMAIL_REGEX));
          ...
          <FormArea
            ...
            value={message}
            onChange={(e) => {
              setMessageInvalid(!e.target.value);
